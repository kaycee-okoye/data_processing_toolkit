"""
    ...
    NOTE
    PLOTS variable will need to be populated in order to use plotter.py
"""
...
# Map containing PlotInfo data classes pertaining
# to sheetnames in an excel that will be plotted using
# plotter.py
# NOTE: the structure of this map is PLOTS[sheet_name] = PlotInfo
PLOTS = {
}
